#!/usr/bin/env python
from models.lidarsr_128_lstm import *
...
def train():
    ...
    history = model.fit_generator(generate_seq_data_from_file(batch_size=1, seq_length=4),
                                ...
                                shuffle=True,
                                workers=1,
                                validation_data=generate_seq_data_from_file(batch_size=1, seq_length=4),
