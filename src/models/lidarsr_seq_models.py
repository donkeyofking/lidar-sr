...
def TCN_net():
    ...
    conv1 = Conv2D(filters=64, kernel_size=(3,3), kernel_regularizer=regularizers.l2(0.01), dilation_rate=(2, 2), padding='same', kernel_initializer='he_normal')
    conv2 = AtrousConvolution2D(filters=64, kernel_size=(3,3), kernel_regularizer=regularizers.l2(0.01), dilation_rate=(2, 2), strides=(2,2), padding='same', kernel_initializer='he_normal')
    ...
    output3=[] # 0,1,2,3
    conv3 = Conv2D(filters=128, kernel_regularizer=regularizers.l2(0.01), kernel_size=(3,3), dilation_rate=(2, 2), padding='same', kernel_initializer='he_normal')
    conv4 = AtrousConvolution2D(filters=128, kernel_regularizer=regularizers.l2(0.01), kernel_size=(3,3), dilation_rate=(2, 2), strides=(2,2), padding='same', kernel_initializer='he_normal')
    ...
    output4=[] # 0,1
    conv5 = Conv2D(filters=256, kernel_regularizer=regularizers.l2(0.01), kernel_size=(3,3), dilation_rate=(2, 2), padding='same', kernel_initializer='he_normal')
    conv6 = AtrousConvolution2D(filters=256, kernel_regularizer=regularizers.l2(0.01), kernel_size=(3,3), dilation_rate=(2, 2), strides=(2,2),  padding='same', kernel_initializer='he_normal')
    ...
    output5=[] # 0
    conv7 = Conv2D(filters=512, kernel_regularizer=regularizers.l2(0.01), kernel_size=(3,3), dilation_rate=(2, 2), padding='same', kernel_initializer='he_normal')
    conv8 = AtrousConvolution2D(filters=512, kernel_regularizer=regularizers.l2(0.01), kernel_size=(3,3), dilation_rate=(2, 2), strides=(2,2), padding='same', kernel_initializer='he_normal')
    ...
    highest_map = Conv2D(filters=1024, kernel_regularizer=regularizers.l2(0.01), kernel_size=(3,3), padding='same', kernel_initializer='he_normal')(highest_map)
    ...
    up1_concat = Conv2D(filters=512, kernel_regularizer=regularizers.l2(0.01), kernel_size=(3,3), padding='same', kernel_initializer='he_normal')(up1_concat)
    ...
    up2_concat = Conv2D(filters=256, kernel_regularizer=regularizers.l2(0.01), kernel_size=(3,3), padding='same', kernel_initializer='he_normal')(up2_concat)
    ...
    up3_concat = Conv2D(filters=128, kernel_regularizer=regularizers.l2(0.01), kernel_size=(3,3), padding='same', kernel_initializer='he_normal')(up3_concat)
    ...
    up4_concat = Conv2D(filters=64, kernel_regularizer=regularizers.l2(0.01), kernel_size=(3,3), padding='same', kernel_initializer='he_normal')(up4_concat)
    ...
    model.compile(optimizer=Adam(lr=0.0001, decay=0.00001), loss='mse', metrics =['accuracy', 'mse' , 'mae', PSNR, ssim_loss ] )
