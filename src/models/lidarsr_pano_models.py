...
#import self defined losses : CD and emd

from models.tf_ops.emd import tf_auctionmatch
from models.tf_ops.CD import tf_nndistance
...
def UNet():
    ...
    inputs = Input((v_max,h_max,channel))
    ...
    outputs = Conv2D(2, (1, 1), activation=act_func)(y0)
    ...
    #SSIM loss from keras_contrib library
