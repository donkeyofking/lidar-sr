...
import sys
sys.path.append("..")
from dataloader.lidarsr_128seq import *
...
def TCN_net():
    ...
    conv1 = Conv2D(filters=64, kernel_size=(3,3), dilation_rate=(2, 2), padding='same', kernel_initializer='he_normal')
    conv2 = AtrousConvolution2D(filters=64, kernel_size=(3,3), dilation_rate=(2, 2), strides=(2,2), padding='same', kernel_initializer='he_normal')
    ...
    output3=[] # 0,1,2,3
    conv3 = Conv2D(filters=128, kernel_size=(3,3), dilation_rate=(2, 2), padding='same', kernel_initializer='he_normal')
    conv4 = AtrousConvolution2D(filters=128, kernel_size=(3,3), dilation_rate=(2, 2), strides=(2,2), padding='same', kernel_initializer='he_normal')
    ...
    output4=[] # 0,1
    conv5 = Conv2D(filters=256, kernel_size=(3,3), dilation_rate=(2, 2), padding='same', kernel_initializer='he_normal')
    conv6 = AtrousConvolution2D(filters=256, kernel_size=(3,3), dilation_rate=(2, 2), strides=(2,2),  padding='same', kernel_initializer='he_normal')
    ...
    output5=[] # 0
    conv7 = Conv2D(filters=512, kernel_size=(3,3), dilation_rate=(2, 2), padding='same', kernel_initializer='he_normal')
    conv8 = AtrousConvolution2D(filters=512, kernel_size=(3,3), dilation_rate=(2, 2), strides=(2,2), padding='same', kernel_initializer='he_normal')
